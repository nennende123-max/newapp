...
export const darkTheme: ThemeTokens = {
  ...
  cssVars: {
    ...
    '--color-bg-input': '#101827',
    '--color-surface': '#111827',
    '--color-surface-elevated': '#1b2637',
    ...
    '--color-bg-rgb': '11 17 32',
    '--color-surface-rgb': '17 24 39',
    '--color-surface-2-rgb': '22 31 46',
    '--color-text-primary-rgb': '229 231 235',
    '--color-text-secondary-rgb': '167 176 192',
    '--color-text-muted-rgb': '119 129 149',
    '--color-border-rgb': '39 50 68',
